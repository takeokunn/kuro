use super::super::{
    attach_session, detach_session, list_sessions, shutdown_session, KuroError, StateError,
    TerminalSession, TERMINAL_SESSIONS,
};
use super::tests_support::{insert_bound_session, insert_detached_session};
...
fn test_attach_session_detached_to_bound() {
    ...
    let is_detached = TERMINAL_SESSIONS
        ...
        .unwrap()
        .get(&ID)
        .is_none_or(TerminalSession::is_detached);
    assert!(
        !is_detached,
