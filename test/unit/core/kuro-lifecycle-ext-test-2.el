;;; kuro-lifecycle-ext-test-2.el --- Lifecycle tests: buffer-init (part 2)  -*- lexical-binding: t; -*-
...
(provide 'kuro-lifecycle-ext-test-2)

;;; kuro-lifecycle-ext-test-2.el ends here
