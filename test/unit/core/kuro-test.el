...
;;; ── Group 9 (ext): kuro-mode buffer-local variable initialization ─────────────
...
;;; ── Group 10 (ext): kuro-mode-map keymap ──────────────────────────────────────
...
;;; ── Group 11 (ext): kuro--make-focus-change-fn — both branches in one call ────
...
;;; ── Group 12 (ext): kuro--window-size-change — function existence ─────────────
...
;;; ── Group 14 (ext): kuro.el constants, guards, and session-level state ─────────
...
;;; ── Group 15 (ext): kuro-mode scroll-margin variables (TUI distortion fix) ────
...
;;; ── Group 16 (ext): FR-007 — Copy mode UX enhancements ───────────────────────
