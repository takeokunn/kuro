;;; kuro-input-test-2.el --- ERT tests for kuro-input.el — Groups 10-23 (regression)  -*-  lexical-binding: t; -*-
...
(ert-deftest kuro-input-send-special-sends-byte ()
  ...
  (kuro-input-test--assert-sends (kuro--send-special ?\C-c) (list (string ?\C-c))))

(ert-deftest kuro-input-send-special-sends-escape ()
  "kuro--send-special sends ESC (0x1B) correctly."
  (kuro-input-test--assert-sends (kuro--send-special ?\e) (list (string ?\e))))
...
(ert-deftest kuro-input-self-insert-noop-for-non-character ()
  ...
  (kuro-input-test--assert-self-insert-sends 'mouse-1 nil))
...
(ert-deftest kuro-input-ctrl-alt-modified-sends-esc-ctrl-byte ()
  ...
  (kuro-input-test--assert-sends (kuro--ctrl-alt-modified ?a 0)
                                  (list (concat (string ?\e) (string (logand ?a 31))))))

(ert-deftest kuro-input-ctrl-alt-modified-sends-esc-ctrl-c ()
  "kuro--ctrl-alt-modified for 'c' sends ESC + ^C (Ctrl+C = 3)."
  (kuro-input-test--assert-sends (kuro--ctrl-alt-modified ?c 0)
                                  (list (string ?\e ?\C-c))))
...
(provide 'kuro-input-test-2)
;;; kuro-input-test-2.el ends here
