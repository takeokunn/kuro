;;; kuro-render-buffer-ext-test.el --- Render buffer tests: line-full, cursor, scroll  -*- lexical-binding: t; -*-

;;; Commentary:
;; ERT tests for kuro-render-buffer.el — Groups 15-20, 27-28.
;; Groups 1-9, 21-26 are in kuro-render-buffer-test.el.
;; Groups 8-14, 29 are in kuro-render-buffer-ext2-test.el.
...
;;; Group 16: kuro--update-cursor (from lines file)
...
;;; From kuro-render-buffer-updates-test.el (Groups 8-14)
