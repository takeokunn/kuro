...
;; Groups 22-28 (frame coalescing, render-cycle, constant invariants)
;; are in kuro-renderer-pipeline-test-2.el.
...
(ert-deftest kuro-renderer-pipeline-poll-within-budget-kills-when-over-budget-and-dead ()
  "kuro--poll-within-budget calls kuro-kill when over budget and process has exited."
  (kuro-renderer-pipeline-test--with-buffer
    (setq-local kuro-frame-rate 30
                kuro-kill-buffer-on-exit t)
    (let ((kill-called nil))
...
(ert-deftest kuro-renderer-pipeline-poll-within-budget-no-kill-when-over-budget-and-kill-off ()
  "kuro--poll-within-budget does not call kuro-kill when kill-on-exit is nil."
  (kuro-renderer-pipeline-test--with-buffer
    (setq-local kuro-frame-rate 30
